...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter', type=int, default=50, help='# of iter at starting learning rate') ##100 next the same
        ...
        self.parser.add_argument('--lr', type=float, default=0.000002, help='initial learning rate for adam') ##0.0002
        self.parser.add_argument('--no_lsgan', action='store_true', help='do *not* use least square GAN, if false, use vanilla GAN')
        self.parser.add_argument('--lambda_A', type=float, default=2.0, help='weight for cycle loss (A -> B -> A)') ##100
        self.parser.add_argument('--lambda_B', type=float, default=1, help='weight for cycle loss (B -> A -> B)')
        self.parser.add_argument('--lambda_identity', type=float, default=2.0,
        ...
        self.parser.add_argument('--lambda_vgg', type=float, default=1.0, help='weight for perceptual loss') ##100
        self.parser.add_argument('--vgg_layer', type=float, default=2, help='layer of vgg for perc loss')
        self.parser.add_argument('--lambda_adv', type=float, default=2.0, help='weight for adversarial loss')